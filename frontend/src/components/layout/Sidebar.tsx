      ...
      >
        ...
        <div className="flex items-center justify-between px-4 h-14 border-b border-border-color shrink-0">
          <Link href="/" className="flex items-center gap-2.5 overflow-hidden">
            ...
            <span className={`font-semibold text-foreground tracking-tight whitespace-nowrap transition-opacity duration-200 ${isOpen ? "opacity-100" : "opacity-0 lg:hidden"}`}>
              CollabDoc
            </span>
          </Link>
          <button
        ...
        <nav className="flex-1 overflow-y-auto py-2 px-2">
          ...
          >
            <HomeIcon />
            <span className={`whitespace-nowrap transition-opacity duration-200 ${isOpen ? "opacity-100" : "opacity-0 lg:hidden"}`}>
              Dashboard
            </span>
          </Link>

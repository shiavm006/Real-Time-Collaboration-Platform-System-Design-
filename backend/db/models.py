...
class User(Base):
    ...
    permissions   : Mapped[list["DocumentPermission"]] = relationship("DocumentPermission", back_populates="user")
    operations    : Mapped[list["OperationLog"]]       = relationship("OperationLog", back_populates="user")
    sessions      : Mapped[list["Session"]]            = relationship("Session", back_populates="user")
    versions      : Mapped[list["Version"]]            = relationship("Version", back_populates="created_by_user")
...
class Document(Base):
    ...
    permissions : Mapped[list["DocumentPermission"]]   = relationship("DocumentPermission", back_populates="document")
    operations  : Mapped[list["OperationLog"]]         = relationship("OperationLog", back_populates="document")
    versions    : Mapped[list["Version"]]              = relationship("Version", back_populates="document")


class DocumentPermission(Base):
    __tablename__ = "document_permissions"
    __table_args__ = (UniqueConstraint("document_id", "user_id", name="uq_doc_permission"),)
